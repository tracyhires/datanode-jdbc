...
public abstract class ConditionalPropertyMapping<PROPERTY_TYPE, COLUMN_TYPE, TEST_COLUMN_TYPE> implements PropertyMapping<PROPERTY_TYPE, COLUMN_TYPE> {
	...
	public ConditionalPropertyMapping(String propertyId, String testColumnId, TEST_COLUMN_TYPE testColumnValue, String primaryColumnId, String secondaryColumnId)
	{
